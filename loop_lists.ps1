...
# powershell -noprofile -executionpolicy bypass -file "C:\Users\kelvi\Desktop\PowerShell\loop_lists.ps1"
...
Get-ChildItem -Path $logFolder -Filter *.txt -Recurse | Remove-Item
